...
<?php include  "connect.php"; ?>
	...
	<form action="order.php" method="post">
		...
		<table align="center" border="1" cellspacing="14" cellpadding="12" style="width: 100%">
          <tr>
			<th> <h3 align="center" style="font-size: 1.3em;">Preencha os Detalhes para Entrega</h3> </th>
		<br>
            </tr>
			    <tr align="center">

			    	<td style="color: red">  Nome  <br>
			    ...
			    <tr align="center">
			    	<td style="color: red">   Telefone <br>
                ...
                <tr align="center">
                	<td style="color: red"> Endereço <br>
